...
DEFAULT_CONFIG = {{cookiecutter.app_slug}}.config.DEFAULT_CONFIG
...
def test_config_permissions_error_read(place_test_config, tmp_path, mocker: pytest_mock.plugin.MockerFixture):
    ...
    with pytest.raises(PermissionError):
        {{cookiecutter.app_slug}}.config.{{cookiecutter.app_camel_case}}Config(instance_path=tmp_path)
...
def test_config_permissions_error_write(place_test_config, tmp_path, mocker: pytest_mock.plugin.MockerFixture):
    ...
    conf = {{cookiecutter.app_slug}}.config.{{cookiecutter.app_camel_case}}Config(instance_path=tmp_path)
