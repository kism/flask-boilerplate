"""Setup the logger functionality for {{cookiecutter.app_slug}}."""
...
# root_logger : root,
# app.logger  : root, {{cookiecutter.app_slug}},
# logger      : root, {{cookiecutter.app_slug}}, {{cookiecutter.app_slug}}.module_name,
